...
<body>
    ...
    <section class="product spad">
        <h2>Welcome to the page <span style="color: green;font-style:bold;">Nutritianist <?php echo $username ?></span></h2>
    </section>
    <!-- Product Section End -->
    ...
    <section>
        <p>For any issues contact with Administrator : <span style="color: blue;"> adminFitfood@gmail.com</span> </p>
    </section>
