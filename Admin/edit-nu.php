...
if ((!isset($_SESSION['username'])) || isset($_GET['logout'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        //  print($status);
        $username = $_POST['username'];
        $query = mysqli_query($con, "Update users set name='$name',email='$email',username='$username',phone='$phone',password='$password',address='$address',nutrition_edu='$nutrition_edu',nutri_experience='$nutri_experience' where user_id='$catid' AND usertype=2");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <title>CleanFood&FitLife | Add Nutritianist</title>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <?php if ($msg) { ?>
                                                <div class="alert alert-success" role="alert">
                                                    <strong>Well done!</strong> Nutritianist Have been Updated
                                                </div>
                                            <?php } ?>
