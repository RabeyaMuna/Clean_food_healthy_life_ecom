...
(29, 95, 4, 8, 1, 1234, 1234, 1),
(30, 96, 4, 9, 1, 1400, 2634, 1),
(31, 97, 4, 10, 1, 2, 2636, 1),
(32, 98, 4, 8, 1, 1234, 1234, 1),
(33, 99, 4, 9, 1, 1400, 2634, 0),
(34, 100, 4, 10, 1, 2, 2636, 0),
(35, 101, 4, 8, 2, 2468, 2468, 1);
...
(15, 'Dr DS', 'ewijfle', 'DS@gmail.com', '123456', '2021-05-14 11:15:00', 2, 'sdkj nskd  sj nksjs njs', 'sLJMsKD nzxnsiduis,kjdjnskz', 'dsnjndcsjiducjisdu', 'Nutritionist', 'DS', 1),
(16, '', 'Nirjoy', 'Nirjoy@gmai.com', '1234567', '2021-05-14 11:16:19', 0, '4,N circuit house Road, Dhaka', '', '', '', 'Nirjoy', 0),
(17, '', 'M', 'M@gmail.com', '801903371766', '2021-05-14 21:15:06', 0, '4,N circuit house Road, Dhaka', '', '', '', 'M', 0),
(18, 'Rabeya Khatun Muna', 'zdxVZ ', 'dz cs', '1233234', '2021-05-15 09:17:54', 2, 'fdvf', 'fdsvz', 'fdvd', 'Nutritionist', 'asc', 1);
...
(12, 4, 'https://www.youtube.com/watch?v=WoftcZDfeoQ', ' These are \"Super Foods\" that are great for your heart. These healthy foods are known to help prevent & fight cancer, heart disease, and other conditions. It was taken from a presentation by Dr. Dory Jarzabkowski, cardiologist with Advocate Heart Institut', '50', 'Super Foods for your Heart', 1);
...
ALTER TABLE `post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `chat_ibfk_1` (`user_post_id`),
  ADD KEY `post_ibfk_2` (`proID`);
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`received_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`sent_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `post`
--
ALTER TABLE `post`
  ADD CONSTRAINT `post_ibfk_1` FOREIGN KEY (`user_post_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `post_ibfk_2` FOREIGN KEY (`proID`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
